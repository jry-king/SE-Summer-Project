...
config_pathname = 'C:\\Users\Bo\\Documents\\models-master\\research\\object_detection\\samples\\configs\\ssdlite_mobilenet_v2_coco.config'


# Input checkpoint for the model to be exported
# Path to the directory which consists of the saved model on disk (see above)
trained_model_dir = 'C:\\Users\\Bo\\Documents\\models-master\\research\\object_detection\\ssdlite_mobilenet_v2_coco_2018_05_09'
...
# Output Directory
output_directory = 'C:\\Users\\Bo\\Documents\\models-master\\research\\object_detection' + str(model_version_id)
